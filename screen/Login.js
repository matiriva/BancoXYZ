...
const Login = ({ navigation }) => {
  ...
  const login_onPress = async () => {
    if (email.length == 0 || password.length == 0) {
      Alert.alert(
        "Entrada incorrecta!",
        "Email y clave no deben estar vacias.",
        [{ text: "Aceptar" }]
      );
      return;
    }
    ...
    postData(url, { email: email, password: password }).then((data) => {
      setDataSrv(data);
      console.log(data);
    });
      ...
      >
        ...
        <View style={styles.action}>
          ...
          <TextInput
            ...
            style={[styles.textInput, { color: "#0F4761" }]}
            autoCapitalize="none"
            inputMode="email"
            onChangeText={(val) => {
              setEmail;
        ...
        {isValidUser ? null : (
          <Animatable.View animation="fadeInLeft" duration={500}>
            <Text style={styles.errorMsg}>
              Email debe tener mas de 4 carácteres.
            </Text>
          </Animatable.View>
        )}
        ...
        {isValidPassword ? null : (
          <Animatable.View animation="fadeInLeft" duration={500}>
            <Text style={styles.errorMsg}>
              Password debe tener al menos 4 carácteres.
            </Text>
          </Animatable.View>
        )}

        <TouchableOpacity>
          <Text style={{ color: "#0F4761", marginTop: 15 }}>
            Olvido su clave?
          </Text>
        </TouchableOpacity>
